...
# Pattern to identify datasets to import
dataset.pattern <- "IsoLagran"

## Import your datasets. This will import all datasets that have been split by eddy and filter, 
## those that are in non-standardized long formats, and those that have been pivoted wider and standardized 
## (aka gone through the NMDS distance matrix production).
